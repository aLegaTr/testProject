...
<form action="${path}" method="post">
    ...
    <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="email" name="email" class="form-control ${(emailError??)?string('is-invalid', '')}" placeholder="email" value="<#if user??>${user.email}</#if>"/>
                <#if emailError??>
                <div class="invalid-feedback">
                    ${emailError}
                </div>
        ...
        <div class="col-sm-6">
             <div class="g-recaptcha" data-sitekey="6LfDBG8UAAAAAMhvcg-JYDqzMTrqAhTFeog_4dgL"></div>
             <#if captchaError??>
